DEFAULT_CHAT_FRAME:AddMessage('[AlterCurrenciesClassic] Showing currency amounts of any character when hovering over any currency on currency tab or any currency cost in items in merchant tabs.', 1,1,0)
AlterCurrencies = {}
